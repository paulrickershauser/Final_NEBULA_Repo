...
def attach_los_visibility_to_target(
    ...
    # Step 2 and 3 are optional: only attach arrays onto target_track when
    # explicitly requested. In multi-observer runs, callers should set
    # attach_to_target=False and store LOS under target['by_observer'][obs_name].
    if attach_to_target:
