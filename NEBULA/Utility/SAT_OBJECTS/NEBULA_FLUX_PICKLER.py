...
# NEBULA sensor configuration: default ACTIVE_SENSOR event camera
...
def attach_flux_to_all_targets(
    ...
    sensor : object or None, optional
        ...
        be one of the sensor objects defined in NEBULA_SENSOR_CONFIG, providing at least:
...
if __name__ == "__main__":
    ...
    # Example with explicit sensor (); you can omit sensor=... to rely on
    # the same default.
