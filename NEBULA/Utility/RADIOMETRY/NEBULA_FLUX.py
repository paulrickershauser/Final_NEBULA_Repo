...
from Configuration.NEBULA_SAT_OPTICAL_CONFIG import (
    ...
    GAIA_G_IRRADIANCE_1AU_W_M2,  # Band-limited solar irradiance in Gaia G [W m⁻²]
...
# Use a band-limited solar irradiance in the Gaia G band as the absolute
# normalization for magnitude-anchored star fluxes and Lambertian satellite fluxes.
F_SUN_G_1AU_W_M2 = GAIA_G_IRRADIANCE_1AU_W_M2
