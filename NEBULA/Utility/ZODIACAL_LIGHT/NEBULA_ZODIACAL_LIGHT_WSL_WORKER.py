...
- observer_itrs_xyz_m OR observer_eci_xyz_km (n_frames, 3)

Note:
- omega_pix_sr is intentionally NOT part of the WSL request schema.
  The backend returns a per-steradian quantity (phi_ph_m2_s_sr). Any
  per-pixel derivation using Ω_pix occurs on the Windows side.
